  ...
  return (
    <article className="mx-auto mt-16 max-w-6xl px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-10 rounded-4xl bg-[#f5f5f5] p-6 sm:p-10 lg:grid-cols-2">
        <div>
          <span className="text-xl font-bold text-[rgb(212,175,55)]">Our Team</span>
          <p className="mt-6 text-lg leading-relaxed text-[#001a3b] sm:text-xl lg:text-2xl lg:leading-10">
            At GCL, our skilled professionals are our most valuable asset. We take pride in our team of highly experienced, zeal, and dedicated
            attorneys, associates, complemented by exceptional supporting staff. Together, we are committed to delivering outstanding and tailored
            legal services to our clients
          </p>
          <Link to={"/our-team"}>
            <Button
              className="mt-8 items-center gap-2 rounded-full border-2 border-white bg-[#001a3b] py-6 text-sm text-white transition-all duration-200 hover:border-[#001a3b] hover:bg-white hover:text-[#001a3b]"
            >
          ...
          {lawyerList.map(({ image, title, appUserId, fullName }) => (
            ...
            >
              ...
              <img
                ...
                alt={`http://localhost:8080/api/v1/files/preview-file?fileName=${image}`}
